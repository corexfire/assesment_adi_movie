...
import com.zubair.assesment.model.Production
import kotlinx.android.synthetic.main.production_item.view.*


class ProductionRVAdapter(private val item: ArrayList<Production>) :
    RecyclerView.Adapter<ProductionRVAdapter.ViewHolder>() {
